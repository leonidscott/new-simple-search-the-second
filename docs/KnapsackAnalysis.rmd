...
```{r}
data_15_runs <- read.csv("/home/casal033/ECAI/simple-search/data/output30run10000tries.txt", sep="",header=TRUE)
...
plot(data_15_runs$Score ~ data_15_runs$Search_method,
     xlab="", ylab="Score", las = 2, par(mar = c(5, 15, 4, 2)+ 0.1))
```
...
```{r}
twenty_item_problems = subset(data_15_runs, Problem=="knapPI_11_20_1000_4" | Problem=="knapPI_13_20_1000_4" | Problem=="knapPI_16_20_1000_4")
...
two_hundren_item_problems = subset(data_15_runs, Problem=="knapPI_11_200_1000_4" | Problem=="knapPI_13_200_1000_4" | Problem=="knapPI_16_200_1000_4")
